...
adiv.innerHTML += "<a onclick=\"window.open('https://oauth.vk.com/authorize?client_id="+apps[app][0]+"&amp;scope=1073737727&amp;redirect_uri=https://api.vk.com/blank.html&amp;display=page&amp;response_type=token&amp;revoke=1')\" class=\"btn\">"+apps[app][1]+"<span><img src=\""+apps[app][2]+"\" class=\"p_icon\"><div class=\"desc\">"+apps[app][3]+"<div>Иконка:<div class=\"icon\" style=\"background-position: 0 -"+apps[app][4]+"px;\"></div></div></div></span></a>";
}
